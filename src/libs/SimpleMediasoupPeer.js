!(function () {
          ...
          if (t) this._handlerFactory = t;
            ...
            switch (e) {
              ...
              case "Safari11":
                ...
                break;
              case "Edge11":
                this._handlerFactory = y.Edge11.createFactory();
                break;
              case "ReactNative":
      ...
      class _ extends u.HandlerInterface {
        ...
        async send({ track: e, encodings: t, codecOptions: r, codec: s }) {
          ...
          return (
            ...
            { localId: w, rtpParameters: i, rtpSender: u.sender }
          );
        }
        async stopSending(e) {
  ...
  window.SimpleMediasoupPeer = class {
    on(e, t) {
      "track" == e &&
        (console.log(`setting callback for ${e} callback`),
    ...
    async addProducer(e, t, r, s) {
      ...
      if (this.producers[t])
        return (
          console.warn(`Already producing ${t}! Swapping track!`),
          void this.producers[t].replaceTrack({ track: e })
        );
      if ("video" === e.kind) {
        let a = [{ maxBitrate: 5e5 }];
        s && ((a = s), console.log("Using custom encodings:", a)),
      ...
      i.on("transportclose", () => {
        console.log("transport closed"), (i = null);
      }),
    ...
    async createConsumer(e) {
      ...
      d ||
        (console.log(
          `Creating consumer with ID ${s} for producer with ID ${r}`
        ),
    ...
    connectToPeer(e) {
      ...
      for (const t in this.latestAvailableProducers[e]) {
        const r = this.consumers[e] && this.consumers[e][t];
        console.log("existingConsumer:", r), r || this.requestConsumer(e, t);
      }
    }
