!(function () {
  ...
  var r =
    ...
    s = {},
    i = {},
    a = r.parcelRequirec509
  function n(e, t, r, s, i, a, n) {
    try {
      var o = e[a](n),
        c = o.value
    } catch (e) {
  ...
  var l = {},
    u = (function (e) {
            ...
            return function (i, a) {
              ...
              for (r.method = i, r.arg = a; ; ) {
                ...
                if ('next' === r.method) r.sent = r._sent = r.arg
                  ...
                  if (s === l) throw ((s = m), r.arg)
                  r.dispatchException(r.arg)
                } else 'return' === r.method && r.abrupt('return', r.arg)
                s = h
                var c = p(e, t, r)
                if ('normal' === c.type) {
                  if (((s = r.done ? m : u), c.arg === f)) continue
                  return { value: c.arg, done: r.done }
                }
                'throw' === c.type &&
                  ((s = m), (r.method = 'throw'), (r.arg = c.arg))
              }
            }
          })(e, r, n)),
          a
      ...
      function P(e, t) {
        function r(i, a, n, o) {
          ...
          if ('throw' !== c.type) {
            var d = c.arg,
              l = d.value
            return l && 'object' == typeof l && s.call(l, '__await')
      ...
      function x(e, r) {
        ...
        if ('throw' === i.type)
          return (r.method = 'throw'), (r.arg = i.arg), (r.delegate = null), f
        var a = i.arg
        return a
          ? a.done
      ...
      return (
        ...
        c(S, 'constructor', v),
        c(v, 'constructor', _),
        (_.displayName = c(v, o, 'GeneratorFunction')),
        ...
        (e.AsyncIterator = P),
        (e.async = function (t, r, s, i, a) {
          void 0 === a && (a = Promise)
          var n = new P(d(t, r, s, i), a)
        ...
        (e.keys = function (e) {
          ...
          return (
            ...
            function r() {
              for (; t.length; ) {
                var s = t.pop()
                if (s in e) return (r.value = s), (r.done = !1), r
              }
              return (r.done = !0), r
            }
          )
        ...
        (C.prototype = {
          ...
          delegateYield: function (e, r, s) {
            return (
              (this.delegate = { iterator: D(e), resultName: r, nextLoc: s }),
  ...
  var h = {},
    ...
    g =
      ...
      function (e) {
        ...
        if (null != e)
          for (var r in e)
            'default' !== r && Object.hasOwnProperty.call(e, r) && m(t, e, r)
        return f(t, e), t
      },
    _ =
      (h && h.__importDefault) ||
  ...
  Object.defineProperty(h, '__esModule', { value: !0 }),
    (h.debug = h.detectDevice = h.Device = h.version = h.types = void 0),
    a.register('j5U6Y', function (e, t) {
      var r = a('fW3Z9')
  ...
  ;(h.debug = v.default),
        ...
        (s = function () {
          return (function (e) {
            ...
            function r(s) {
              ...
              return (
                e[s].call(i.exports, i, i.exports, r), (i.l = !0), i.exports
              )
            }
            return (
              (r.m = e),
    ...
    a.register('6DeKT', function (e, t) {
      'use strict'
      Object.defineProperty(e.exports, '__esModule', { value: !0 }),
        (e.exports.EnhancedEventEmitter = void 0)
      var r = a('ktjSa')
      const s = new (a('6pHSb').Logger)('EnhancedEventEmitter')
      ...
      e.exports.EnhancedEventEmitter = i
    }),
    a.register('ktjSa', function (e, t) {
      'use strict'
      var r,
    ...
    a.register('d0NZR', function (e, r) {
      ...
      const E = a('j5U6Y')('h264-profile-level-id')
    ...
    a.register('eYbsu', function (e, t) {
      'use strict'
      Object.defineProperty(e.exports, '__esModule', { value: !0 }),
        (e.exports.DataConsumer = void 0)
      var r = a('6pHSb'),
        s = a('6DeKT')
      const i = new r.Logger('DataConsumer')
        ...
        n = function (e, t, r) {
          ...
          if (t.names)
            for (var a = 0; a < t.names.length; a += 1) {
              var n = t.names[a]
              t.name ? s.push(r[t.name][n]) : s.push(r[t.names[a]])
            }
  ...
  var b = a('cUDrk')
  Object.defineProperty(h, 'Device', {
    enumerable: !0,
    get: function () {
      return b.Device
    },
  }),
    Object.defineProperty(h, 'detectDevice', {
      enumerable: !0,
      get: function () {
        return b.detectDevice
      },
    }),
    a.register('adPEn', function (e, t) {
      'use strict'
      var r =
          (e.exports && e.exports.__createBinding) ||
          (Object.create
    ...
    a.register('a4qeh', function (e, t) {
      'use strict'
      Object.defineProperty(e.exports, '__esModule', { value: !0 })
    }),
    a.register('8c4LC', function (e, t) {
      'use strict'
      Object.defineProperty(e.exports, '__esModule', { value: !0 })
    })
  const y = g(a('adPEn'))
  ;(h.types = y), (h.version = '3.6.43')
  var w = a('at4BN')
  Object.defineProperty(h, 'parseScalabilityMode', {
    enumerable: !0,
    get: function () {
      return w.parse
    },
  ...
  var S = (function () {
    ...
    function t(r) {
      ...
      console.log('Setting up new MediasoupPeer'),
        (this.device = null),
        (this.socket = r),
        (this.socket.request = function (e, t) {
          var s = void 0 === t ? {} : t
          return new Promise(function (t) {
            r.emit(e, s, t)
          })
        }),
        this.socket.on('mediasoupSignaling', function (e) {
      ...
      (s = [
        {
          ...
          value: function (e, t) {
            'track' == e &&
              (console.log('setting callback for '.concat(e, ' callback')),
              (this.onTrackCallback = t))
          },
        },
        {
          key: 'callOnTrackCallback',
          value: function (e) {
            var t = e.track,
              r = e.peerId,
              s = e.label
            this.onTrackCallback
              ? this.onTrackCallback(t, r, s)
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 4:
                            return (e.next = 6), this.createSendTransport()
                          case 6:
                            return (e.next = 8), this.createRecvTransport()
                          case 8:
                            for (r in this.tracksToProduce)
                              (s = this.tracksToProduce[r].track),
                                (i = this.tracksToProduce[r].broadcast),
                                (a = this.tracksToProduce[r].customEncodings),
                                this.addProducer(s, r, i, a)
                          case 9:
                          case 'end':
                            return e.stop()
                        }
                    ...
                    function (a) {
                      for (;;)
                        switch ((a.prev = a.next)) {
                          case 0:
                            if (((n = this), !this.producers[r])) {
                              a.next = 6
                              break
                            }
                            return (
                              console.warn(
                                'Already producing '.concat(
                                  r,
                                  '! Swapping track!'
                                )
                              ),
                              this.producers[r].replaceTrack({ track: t }),
                              a.abrupt('return')
                            )
                          case 6:
                            if ('video' !== t.kind) {
                            ...
                            return (
                              ...
                              i &&
                                ((d = i),
                                console.log('Using custom encodings:', d)),
                              (a.next = 11),
                          ...
                          case 19:
                            c = a.sent
                          case 20:
                            c.on('transportclose', function () {
                              console.log('transport closed'), (c = null)
                            }),
                              c.on(
                                'trackended',
                                (function () {
        ...
        {
          key: 'ensureConnectedToDesiredPeerConnections',
          value: function () {
            for (var e in (console.log('ensure connections'),
            console.log(
              'latest available producers:',
              this.latestAvailableProducers
            ),
            console.log('desired connections:', this.desiredPeerConnections),
            this.latestAvailableProducers))
              if (e !== this.socket.id)
                for (var t in this.latestAvailableProducers[e])
                  if (
                    this.desiredPeerConnections.has(e) ||
                    this.latestAvailableProducers[e][t].broadcast
                  ) {
                    var r = this.consumers[e] && this.consumers[e][t]
                    console.log('existing consumer:', r),
                      r || this.requestConsumer(e, t)
                  }
          },
        },
        {
                        ...
                        switch ((e.prev = e.next)) {
                          case 0:
                            if (
                              ...
                              (c = t.appData),
                              t.producerPaused,
                              this.consumers[s] || (this.consumers[s] = {}),
                              (d = this.consumers[s][i]))
                            ) {
                              e.next = 14
                              break
                            }
                            return (
                              (u = this),
                              console.log(
                                'Creating consumer with ID '
                                  .concat(a, ' for producer with ID ')
                                  .concat(i)
                              ),
                              (e.next = 8),
                              this.recvTransport.consume({
                                ...
                                kind: n,
                                rtpParameters: o,
                                appData: p({}, c, { peerId: s }),
                              })
                            )
                          case 8:
                            return (
                              (d = e.sent),
                              console.log('Created consumer:', d),
                              (this.consumers[s][i] = d),
                              d.on('transportclose', function () {
                                delete u.consumers[d.id]
                              }),
                              (e.next = 14),
                              this.socket.request('mediasoupSignaling', {
                                type: 'resumeConsumer',
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          ...
                          case 3:
                            return (
                              console.log('tick'),
                              (this.latestAvailableProducers = t.data),
                              this.ensureConnectedToDesiredPeerConnections(),
                              e.abrupt('break', 15)
                            )
                          case 7:
                            return (
                              this.createConsumer(t.data), e.abrupt('break', 15)
                            )
                          case 9:
                            return (
                              console.log(
                              ...
                              (i = s.producingPeerId),
                              (a = s.producerId),
                              this.consumers[i][a].close(),
                              delete this.consumers[i][a],
                              e.abrupt('break', 15)
                            )
                          case 15:
                          case 'end':
                  ...
                  return e(l).wrap(
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            for (s in this.consumers[t])
                              this.consumers[t][s].close()
                            delete this.consumers[t]
                          case 2:
                          case 'end':
                            return e.stop()
                        }
        ...
        },
        {
          key: 'connectToPeer',
          value: function (e) {
            for (var t in (this.desiredPeerConnections.add(e),
            this.latestAvailableProducers[e])) {
              var r = this.consumers[e] && this.consumers[e][t]
              console.log('existingConsumer:', r),
                r || this.requestConsumer(e, t)
            }
          },
        },
        {
          ...
          value: function (e) {
            for (var t in this.consumers[e]) this.consumers[e][t].close()
                    ...
                    function (e) {
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            ;(s = this.consumers[t]),
                              (e.t0 = regeneratorRuntime.keys(s))
                          case 2:
                            if ((e.t1 = e.t0()).done) {
                              e.next = 14
                              break
        ...
        {
          key: 'setupMediasoupDevice',
          value: function () {
            try {
              this.device = new h.Device()
            } catch (e) {
              console.error(e)
            }
          },
                        ...
                        switch ((e.prev = e.next)) {
                          ...
                          case 2:
                            return (
                              (r = e.sent),
                              (e.next = 5),
                              this.device.load({ routerRtpCapabilities: r })
                            )
                          case 5:
